...
<head>
    ...
    <style>
        ...
        .btn-submit:hover {
            background: linear-gradient(90deg, #00a846, var(--success-color));
...
<header class="header-bar">
    <h5><i class="fas fa-plus-circle me-2"></i>Add New FAQ</h5>
...
<main class="main-content" role="main">
    <div class="faq-container">
        ...
        <form action="AddFAQServlet" method="post" enctype="multipart/form-data" id="faqForm">
            <!-- Question -->
            <div class="mb-3">
                ...
                <input type="text" id="question" name="question" class="form-control"
                       placeholder="Enter the FAQ question" required maxlength="200">
            ...
            <div class="mb-3">
                ...
                <textarea id="answer" name="answer" rows="5" class="form-control"
                          placeholder="Provide a detailed answer" required maxlength="1000"></textarea>
                <div class="char-counter">
                    <span id="answerCharCount">0</span>/1000
                </div>
            </div>

            <!-- Image -->
            <div class="mb-3">
                <label for="faqImage" class="form-label">Attach Image (optional):</label>
            ...
            <button type="submit" class="btn-submit" id="submitBtn">
                <i class="fas fa-check-circle"></i> Publish FAQ
            </button>
        </form>
    </div>
</main>
