...
<head>
    ...
    <style>
        ...
        .btn-primary {
            width: 100%;
            padding: 12px;
            background: linear-gradient(90deg,#8e44ad 60%,#9b59b6 100%);
            border: none;
            color: #fff;
            font-size: 16px;
            border-radius: 8px;
...
<div class="login-container">
    ...
    <div class="login-left">
        <div class="login-left-content">
            <h2>Admin Portal</h2>
            <p>Manage system settings, oversee operations, and access administrative tools.</p>
        </div>
    </div>
        ...
        loginTypeSelect.addEventListener('change', function() {
            ...
            switch(selectedType) {
                ...
                case 'student':
                    ...
                    break;
                // Admin is the current page, no action needed
            }
        });
    });
</script>
