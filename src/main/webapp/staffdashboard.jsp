...
<head>
    ...
    <style>
        body { background-color: #1b1b1b; color: #fff; min-height: 100vh; margin: 0; font-family: 'Poppins', sans-serif; }
        ...
        .main-content { margin-left: 220px; padding: 2rem; min-height: 100vh; margin-top: 70px; }
...
<nav class="sidebar" aria-label="Sidebar Navigation">
    ...
    <a href="StaffTicketsManageServlet"><i class="fas fa-ticket-alt"></i> Manage Tickets</a>
    <a href="FAQliststaff.jsp"><i class="fas fa-question-circle"></i> FAQs</a>
    ...
    <%
        ...
        try (Connection conn = com.example.demo.utils.DBConnection.getConnection()) {
            ...
            try (PreparedStatement ps = conn.prepareStatement(
                    "SELECT TOP 10 ticketId, username, email, category, status, created_at FROM tickets ORDER BY created_at DESC");
                 ResultSet rs = ps.executeQuery()) {
                while(rs.next()) {
                    Map<String,String> t = new HashMap<>();
                    t.put("id", rs.getString("ticketId"));
